...
public:
  explicit image_format_error(const std::string &arg = "")
      : std::logic_error(arg) {}
};

class not_supported_format : public std::runtime_error {
public:
  explicit not_supported_format(const std::string &arg = "")
      : std::runtime_error(arg) {}
};

class invalid_argument : public std::invalid_argument {
public:
  explicit invalid_argument(const std::string &arg = "")
      : std::invalid_argument(arg) {}
};

class file_io_failed : public std::runtime_error {
public:
  explicit file_io_failed(const std::string &arg = "")
      : std::runtime_error(arg) {}
};
