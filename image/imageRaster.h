...
void adjustContrast(const IMAGE::ImageRaster &, const unsigned char,
                    const unsigned char);
...
void zoomImage(IMAGE::ImageRaster &, unsigned int, unsigned int, unsigned int,
               unsigned int);
...
public:
  ...
  void createRaster(const ImageRaster &) throw(IMAGE::bad_alloc,
                                               IMAGE::empty_raster);
  ...
  void createRaster(const unsigned int, const unsigned int,
                    const unsigned int) throw(IMAGE::bad_alloc,
                                              IMAGE::invalid_argument);
  ...
  friend void PROCESS::adjustBrightness(const IMAGE::ImageRaster &,
                                        const signed short);

  friend void PROCESS::adjustContrast(const IMAGE::ImageRaster &,
                                      const unsigned char, const unsigned char);

  friend void PROCESS::adjustContrast(const IMAGE::ImageRaster &,
                                      const unsigned short);

  friend void FILTERS::convertRGB2GREY(const IMAGE::ImageRaster &,
                                       const unsigned short);
  ...
  friend void PROCESS::scaleImage(IMAGE::ImageRaster &, unsigned int,
                                  unsigned int);
